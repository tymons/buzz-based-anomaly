...
class TestConvolutional1DVAEModelMethods(unittest.TestCase):

    def test_conv1d_vae_model_is_build_basic_setup(self):
    ...
    def test_conv1d_vae_model_is_build_with_input_size_2053(self):
    ...
    def test_conv1d_vae_model_is_build_with_max_pool_3(self):
        config, input_size = get_default_config()
        config['max_pool'] = 3
    ...
    def test_conv1d_vae_model_is_build_with_padding_4(self):
        config, input_size = get_default_config()
        config['padding'] = 4
    ...
    def test_conv1d_vae_model_is_build_with_kernel_6(self):
        config, input_size = get_default_config()
        config['kernel'] = 6
    ...
    def test_conv1d_vae_model_inference(self):
        config, input_size = get_default_config()
        batch_size = 32
        input_tensor = torch.empty((batch_size, 1, input_size))
        model: BaseModel = HiveModelFactory.build_model(HiveModelType.from_name('conv1d_vae'),
                                                        (input_size,), config)
